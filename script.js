...
[풀이 가이드라인]
1. 지나치게 감성적이거나 과장된 수식어('사랑하는', '존경하는' 등)는 절대 피하고, 명리학 전문가답게 담백하고 깔끔한 어조를 유지하세요.
2. 각 항목별로 '타고난 강점과 긍정적인 부분'을 먼저 명확히 설명한 뒤, '주의해야 할 점'과 이를 극복할 수 있는 '구체적이고 현실적인 조언'을 분리하여 객관적이면서도 균형 잡힌 해석을 제공하세요.
