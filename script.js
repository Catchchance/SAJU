...
[풀이 가이드라인]
1. '따뜻하게', '사랑하는', '존경하는', '위로가 되는' 등 감성적이거나 수식어가 많은 표현은 일절 제외하고, 명리학 전문가답게 담백하고 직설적인 어조를 유지하세요.
2. 각 항목별로 '타고난 강점과 긍정적인 부분'을 명확히 설명한 뒤, '주의해야 할 점'과 '현실적이고 구체적인 조언'을 분리하여 객관적이고 균형 잡힌 해석을 제공하세요.
